...
private void cargarAnimal(Sector sec, int opcion)
{
	...
	double alimentacionDiaria = Double.parseDouble(JOptionPane.showInputDialog("Ingrese la cantidad de alimento diaria que consume"));
	...
	case 1:
		...
		vol.setTipoAlimentacion(JOptionPane.showInputDialog("Ingrese tipo de alimentacion(Carnivoro/Omnivoro/Herbivoro)"));
		sec.agregarAnimal(vol);
		break;
	case 2:
		Acuatico acua = new Acuatico(nombre,peso,raza,especie,estadoSalud,sexo,alimentacionDiaria,fecha);
		acua.setTipoAlimentacion(JOptionPane.showInputDialog("Ingrese tipo de alimentacion(Carnivoro/Omnivoro/Herbivoro)"));
